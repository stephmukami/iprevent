  ...
  return (
    ...
    <div className="min-h-screen min-w-screen">
        ...
        <div className=" text-container p-[20px] bg-black text-white  w-screen  border border-red-300  ">
            ...
            <div className="gestational-diabetes-div mb-6 flex flex-col md:flex-row space-x-6 items-center border border-red-300">
              <div className="flex items-center mb-4 md:mb-0">
            ...
            <div className="previous-history-div mb-6 flex flex-col md:flex-row space-x-6 items-center border border-red-300">
              <div className="flex items-center mb-4 md:mb-0">
